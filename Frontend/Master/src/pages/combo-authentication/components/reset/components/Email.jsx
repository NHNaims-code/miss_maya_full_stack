...
export default function Email() {
  return (
    <div className='reset_email__root mt-10 p-[30px]'>
      <p className='text-center'>A code will be emailed to you to reset your password</p>
      <NeuRoundedDownInput type='email' placeholder='Please enter your email' className='mt-5'/>
      <div className="mt-5 flex justify-center">
        <NeuActionButton successText='Request Code'>Request Code</NeuActionButton>
      </div>

      <div className="flex justify-between mt-10">
        <div className='text-[14px]'>A code has been sent to your email</div>
        <div className='text-[12px] font-semibold'>resend code</div>
      </div>
      <div className="flex justify-center mt-5">
        <NeuUpContainer>
          <div className="flex flex-col items-center">
            <img src="/assets/images/EMAIL_OTP.png" alt="" />
          ...
          <div className="flex flex-col items-center mt-10">
            ...
            <small className='text-[12px]'>Email verified</small>
          </div>
        </NeuUpContainer>
      </div>
      <div className="">
